    ...
    <main className="max-w-3xl mx-auto px-6 py-10">
      <nav className="flex items-center justify-between mb-12">
        <div className="flex items-center gap-3">
          <span className="font-display text-xl font-bold bg-brand-gradient bg-clip-text text-transparent">
            ArcShift
          </span>
          <span className="text-xs bg-brand/10 border border-brand/30 text-brand-light px-2 py-0.5 rounded-full">
            TESTNET
          </span>
        </div>
        <ConnectButton />
      ...
      <div className="mb-10">
        ...
        <p className="text-muted text-base max-w-lg leading-relaxed">
          Send USDC from {primary.label} to any supported chain with one click.
          Approve, deposit, sign, and mint — all handled automatically.
        </p>
      </div>
